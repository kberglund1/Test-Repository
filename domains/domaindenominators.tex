...
Find the domain of $f$ for $f(x) = \frac{1}{(x + 3)(x - 5)}$.
		\begin{explanation}
			\begin{expandable}
...
Find the domain of $f$ for $f(x) = \frac{1}{x^2 - x - 6}$.
		\begin{explanation}
			\begin{expandable}
...
Find the domain of $f$ for $f(x) = \frac{12x}{|x| - 3}$.
		\begin{explanation}
			\begin{expandable}
...
Find the domain of $f$ for $f(x) = \frac{x - 2}{(x + 7)(x - 1)}$.
		\begin{explanation}
			\begin{expandable}
...
Find the domain of $f$ for $f(x) = \frac{x - 4}{x - 3}$.
		\begin{explanation}
			\begin{expandable}
